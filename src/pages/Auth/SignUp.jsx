...
const SignUp = () => {
    ...
    useEffect(() => {
        const getPoblations = async () => {
            try {
                ...
                setCities(cities);
                const countries = [...new Set(relations.map((obj) => Object.values(obj)[0]))];
    ...
    const handleChangeCountry = (e) => {
        ...
        setCities(filtered.length > 0 ? filtered : relations.map((relation) => Object.keys(relation)[0]));
        handleChange(e);
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const { email, password, name, surname, birthdate, display_name, country, city, description } = formData;
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                <Row>
                    ...
                    <Col {...selects.country.size}>
                        <Form.Select ref={countrySelect} size="lg mb-3" onChange={handleChangeCountry}>
